  ...
  return (
    <footer data-nosnippet='' className='container-base space-y-8 py-14 text-center md:py-[60px]'>
      ...
      <div className='text-ink/70 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 md:gap-x-8'>
        ...
        <a className='shrink-0' href='https://www.linkedin.com/in/mert-ercan' target='_blank' rel='noopener noreferrer'>
          LinkedIn
        </a>
        ...
        <a className='shrink-0' href='https://www.pinterest.com/mertcreates' target='_blank' rel='noopener noreferrer'>
          Pinterest
        </a>
      </div>
